                ...
                <div class="vi-ui bottom attached tab segment active" data-tab="general">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <a class="vi-ui button"
                                   href="https://goo.gl/2hWzFT"><?php echo esc_html__( 'Update This Feature', 'woo-multi-currency' ) ?></a>
                            ...
                            <td colspan="2">
                                ...
                                <table class="vi-ui  table wmc-currency-options">
                                    ...
                                    <tr>
                                        ...
                                        <th class="two wide"
                                            colspan="2"><?php esc_html_e( 'Rate + Exchange Fee', 'woo-multi-currency' ) ?>
                                            (<a href="https://goo.gl/2hWzFT"><?php echo esc_html__( 'Update This Feature', 'woo-multi-currency' ) ?></a>)
                                        </th>
									...
									foreach ( $currencies as $key => $currency ) {
                                        ...
                                        <tr class="wmc-currency-data <?php echo $currency . '-currency' ?>">
                                            ...
                                            <td>
                                                <input type="text" placeholder="eg: CAD #PRICE#"
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="location">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr>
                            <th scope="row">
                                <label>
									<?php esc_html_e( 'WPML Language switcher', 'woo-multi-currency' ) ?>
                                </label>
                            </th>
                            <td>
                                <a class="vi-ui button"
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="checkout">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label>
									<?php esc_html_e( 'Payment methods control', 'woo-multi-currency' ) ?>
                                </label>
                            </th>
                            <td>

                                <p class="description"><?php esc_html_e( 'You can show or hide payment methods for specify currency.', 'woo-multi-currency' ) ?>
                                    <a class="vi-ui button"
                                       href="https://goo.gl/2hWzFT"><?php echo esc_html__( 'Update This Feature', 'woo-multi-currency' ) ?></a>
